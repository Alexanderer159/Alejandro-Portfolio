...
<>
    <div className="services-top-container d-flex flex-column animated">
        ...
        <div className="service-card-group d-flex p-5 gap-5">
            ...
            <div className="service-card d-flex flex-column justify-content-start align-items-center">
            ...
            <div className="service-card d-flex flex-column justify-content-center align-items-center">
                ...
                <p className="inside-service-card m-0 p-2 text-center"><strong className="emphasis">CD/CI</strong> focused work</p>
            </div>

            <div className="service-card d-flex flex-column justify-content-end align-items-center">
                <p>a</p>
