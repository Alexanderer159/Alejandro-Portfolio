    ...
    <div className="all pt-4 pb-5">
      ...
      <div className="top">
        ...
        <div className="d-flex justify-content-center animated">
          <a data-scroll href="#groups" className="arrow">
          </a>
        </div>
      </div>

      <div id="groups">
        <div className="animated d-flex justify-content-center mt-5 pt-5" id="projects">
            <div>
              ...
              <div id="carousel" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner">
                  <div className="carousel-item active">
                    <img src="prueba.jpg" className="d-block" alt="Pic 1"/>
                  </div>
                  <div class="carousel-item">
                    <img src="prueba2.jpg" className="d-block" alt="Pic 2"/>
                  </div>
                  <div class="carousel-item">
                    <img src="prueba.jpg" className="d-block" alt="Pic 3"/>
                  </div>
                </div>
        ...
        <div className="animated d-flex justify-content-center mt-5 pt-5" id="testimonials">
          <div>
        ...
        <div className="animated d-flex justify-content-center mt-5 pt-5" id="contact">
            <div>
