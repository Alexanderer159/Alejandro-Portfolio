        ...
        <div className="d-flex justify-content-center align-items-center gap-5 animated pt-3">
          ...
          <div className="info p-5">
              ...
              <div className="d-flex gap-3 pt-4 mt-4">
                ...
                <a href="CV-Alejandro De Yavorsky.pdf" download="Alejandro/CV-Alejandro-De-Yavorsky.pdf">
                  <button className="buttonCV p-2">
                    📜 Download My CV      
                  </button>
                </a>

                <a href="https://wa.me/+34613502876">
...
<div id="middle"></div>
      ...
      <div className="d-flex flex-column justify-content-between">
        ...
        <div className="services">
          ...
          <div className="services-group d-flex flex-row justify-content-center align-items-center">

            <p className="">Design webpages</p>
            <p className="">Mantain code and update</p>
            <p className="">Tackle Big front-end projects</p>
        ...
        <div className="animated d-flex flex-column justify-content-center align-items-center">
            ...
            <div className="d-flex flex-row gap-5">
              ...
              <a href="https://github.com/Alexanderer159" target="_blank">
                <button className="contact-button d-flex flex-column justify-content-between">
                  <svg xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" clipRule="evenodd" viewBox="0 0 512 499.368">
              ...
              <a href="mailto:traledeyavorsky@gmail.com?&subject=Inquiry%20about%20services.&body=I%20would%20like%20to%20inquire%20about%20your%20services%20and%20would%20like%20to%20set%20up%20a%20meeting!" target="_blank">
                <button className="contact-button d-flex flex-column justify-content-between">
                  <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.88 85.57">
